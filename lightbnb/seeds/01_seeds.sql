...
INSERT INTO properties (owner_id, title, description, thumbnail_photo_url, cover_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, country, street, city, province, post_code, active) VALUES (2, house of cards, description, https:image, https://image2, 62061, 8, 2 ,1, Canada, 237 jasper ave, edmonton, alberta, T1J7H4, true);
INSERT INTO properties (owner_id, title, description, thumbnail_photo_url, cover_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, country, street, city, province, post_code, active) VALUES (3, tiny hoome, description, https:image, https://image2, 54136, 2, 1 ,0, Canada, 357 rocky road , canmore, alberta, T2K0E4, true);
...
INSERT INTO property_review (guest_id,property_id, reservation_id, rating, message) VALUES (3,2,1,3, message);
INSERT INTO property_review (guest_id,property_id, reservation_id, rating, message) VALUES (2,2,2,4, message);
INSERT INTO property_review (guest_id,property_id, reservation_id, rating, message) VALUES (3,1,3,5, message);